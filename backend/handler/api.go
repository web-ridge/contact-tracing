...
const AUTH_ERROR_MESSAGE = "not authorized"
const AUTH_ERROR_CODE = http.StatusForbidden
const AUTH_ERROR_INTERNAL_CODE = "AUTH_ERROR"
...
func WriteAuthError(w http.ResponseWriter) {
	WriteJSONError(w, AUTH_ERROR_MESSAGE, AUTH_ERROR_INTERNAL_CODE, AUTH_ERROR_CODE)
}
