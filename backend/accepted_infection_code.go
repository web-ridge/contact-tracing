...
func userAcceptedInfectionCode(w http.ResponseWriter, r *http.Request) {
	...
	var databaseInfectionCode InfectionCode
	if err := db.Model(&InfectionCode{}).Where(&InfectionCode{
