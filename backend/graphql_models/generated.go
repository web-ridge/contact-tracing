...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.infectedEncounters":
		...
		return e.complexity.Query.InfectedEncounters(childComplexity, args["deviceHashesOfMyOwn"].([]*DeviceKeyParam)), true
...
func (ec *executionContext) _Query_infectedEncounters(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().InfectedEncounters(rctx, args["deviceHashesOfMyOwn"].([]*DeviceKeyParam))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
